...
var audioPath;  //audio for the response
...
async function shakeBall() {
    //Instantiates the chime audio, textToSpeech audio as well as the click prompt message
    ...
    setTimeout(() => {
        ...
        if (nameInput.replace(/\s+/g, '') == '') {
            ...
            //Wait for text to fade in to play the response
            setTimeout(() => {
...
async function langMenuChange() {
    ...
    let prompt = document.getElementById("clickPrompt"); //click prompt element
    ...
    switch (selection.value) {
        case "spanish":
            ...
            prompt.innerHTML = "Haga clic para agitar";
            break;
        case "chinese":
        ...
        default:
            ...
            prompt.innerHTML = "Click to Shake";
            break;
    }
